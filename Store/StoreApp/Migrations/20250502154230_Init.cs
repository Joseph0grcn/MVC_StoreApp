    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "/images/1.png", 17000m, "Computer", false, "" },
                    { 2, 2, "/images/2.png", 1000m, "Keyboard", false, "" },
                    { 3, 2, "/images/3.png", 500m, "Mouse", false, "" },
                    { 4, 2, "/images/4.png", 7000m, "Monitor", false, "" },
                    { 5, 2, "/images/5.png", 1500m, "Deck", false, "" },
                    { 6, 1, "/images/6.png", 1500m, "History", false, "" },
                    { 7, 1, "/images/7.png", 1500m, "Hamlet", false, "" },
                    { 8, 1, "/images/1.png", 1000m, "xp-pen", true, "" },
                    { 9, 2, "/images/2.png", 10300m, "samsung-tel", true, "" },
                    { 10, 1, "/images/3.png", 10000m, "ıphone-tel", true, "" }
                });
